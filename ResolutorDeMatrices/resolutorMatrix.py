...
def iniciar_interfaz(parent):
    ...
    # Pestaña "Bisección"
    tab_biseccion = notebook.tab("Biseccion")
    label_biseccion = ctk.CTkLabel(tab_biseccion, text="Método de Bisección")
    label_biseccion.pack(pady=10)
    ...
    # Consola para mostrar los resultados
    consola_biseccion = ctk.CTkTextbox(tab_biseccion, height=200, width=500, font=("Courier", global_font_size))
